...
import { btns, BtnActions } from "./btnConfig";
...
export function Calculator() {
  ...
  const btnClick = (item) => {
    ...
    if (item.action === BtnActions.THEME)
      document.body.classList.toggle("dark");

    if (item.action === BtnActions.ADD) {
    ...
    if (item.action === BtnActions.DELETE) {
    ...
    if (item.action === BtnActions.CALC) {
